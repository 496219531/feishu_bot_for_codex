...
RESTART_SESSION="${RESTART_SESSION:-feishu-codex-restart}"
BOT_SESSION_NAME="${BOT_SESSION_NAME:-feishu-codex}"
LOG_FILE="${LOG_FILE:-$ROOT_DIR/feishu-bot-restart.log}"
WORKER_SCRIPT="$ROOT_DIR/scripts/feishu-bot-restart.sh"
