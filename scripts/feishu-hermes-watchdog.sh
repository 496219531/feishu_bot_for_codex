...
STATUS_SCRIPT="$ROOT_DIR/scripts/feishu-hermes-status.sh"
START_SCRIPT="$ROOT_DIR/scripts/feishu-hermes-start.sh"
RESTART_SCRIPT="$ROOT_DIR/scripts/feishu-hermes-restart.sh"
